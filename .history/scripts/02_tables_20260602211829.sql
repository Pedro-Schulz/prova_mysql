...
CREATE TABLE produto_industrial (
    ...
    qtdEstoque_produto INT NOT NULL,
...
drop table produto_industrial, ordem_producao, controle_qualidade;

CREATE TABLE fornecedor (
    id_fornecedor SMALLINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    cnpj_fornecedor CHAR(11) NOT NULL UNIQUE,
    telefone_fornecedor CHAR(13) NOT NULL,
    cidade_fornecedor VARCHAR(100)
);

CREATE TABLE controle_qualidade (
    id_cq SMALLINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    dataInspecao_cq DATE NOT NULL,
    observacoesTecnicas_cq TEXT,
    resultado_cq TEXT NOT NULL,
    id_op SMALLINT NOT NULL,
