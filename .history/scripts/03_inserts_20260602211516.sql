...
INSERT INTO fornecedor (id_fornecedor, cnpj_fornecedor, telefone_fornecedor, cidade_fornecedor) VALUES
    (1, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'Guarulhos'),
    (123, 35452, 1243123451234, 'Manaus'),
    (123, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'Belo Horizonte'),
    (123, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'Rio de Janeiro'),
    (123, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'São Paulo'),
    (123, 35452, 1243123451234, 'São Paulo');