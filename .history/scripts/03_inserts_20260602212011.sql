...
INSERT INTO funcionario (id_funcionario, nome_funcionario, cargo_funcionario, cpf_funcionario, salario_funcionario, id_setor) VALUES
    ...
    (345, 'Romario', 'Operador', 12335455657, 3200, 123),
    (572, 'Estevao', 'Zelador', 12335455657, 10000, 123),
    (341, 'Diego', 'Administrador', 12335455657, 7200, 123),
    (673, 'Rogerio', 'Diretor', 12335455657, 11200, 123),
    (223, 'Homologo', 'Gerente', 12335455657, 1200, 123),
    (555, 'Lorabelta', 'Operador', 2356761233545565745686, 3200, 123),
    (777, 'Viranldo', 'Zelador', 823345677657, 10000, 123),
    (561, 'lindoberto', 'Administrador', 12383455657, 7200, 123),
    (863, 'Tutaco', 'Diretor', 455755657, 11200, 123);
...
INSERT INTO produto_industrial (id_produtoIndustrial, nome_produto, descricao_produto, precoFabricacao_produto, qtdEstoque_produto, categoria_produto, id_fornecedor) VALUES
    (3451, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3452, 'tomate', 'podre', 2.99, 123, 'frutas', 134),
    (3453, 'pera', 'podre', 2.99, 123, 'frutas', 134),
    (3454, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3455, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3456, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3457, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3458, 'laranja', 'podre', 2.99, 124, 'frutas', 134),
    (3459, 'laranja', 'podre', 2.99, 134, 'frutas', 134),
    (3416, 'laranja', 'podre', 2.99, 234, 'frutas', 134),
    (3426, 'laranja', 'podre', 2.99, 234, 'frutas', 134),
    (3436, 'laranja', 'podre', 2.99, 234, 'frutas', 134),
    (3446, 'laranja', 'podre', 2.99, 234, 'frutas', 134),
    (1235, 'laranja', 'podre', 2.99, 123, 'frutas', 134),
    (3466, 'laranja', 'podre', 2.99, 124, 'frutas', 134),
    (3476, 'laranja', 'podre', 2.99, 134, 'frutas', 134);
