...
INSERT INTO funcionario (id_funcionario, nome_funcionario, cargo_funcionario, cpf_funcionario, salario_funcionario, id_setor) VALUES
    ...
    (345, 'Romario', 'Operador', 231237645686, 3200, 123),
    (572, 'Estevao', 'Zelador', 12334568657, 10000, 123),
    (341, 'Diego', 'Administrador', 12383455657, 7200, 123),
    (673, 'Rogerio', 'Diretor', 18334455657, 11200, 123),
    (223, 'Homologo', 'Gerente', 12334458657, 1200, 123),
    (555, 'Lorabelta', 'Operador', 23567645686, 3200, 123),
