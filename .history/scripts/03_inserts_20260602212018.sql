...
INSERT INTO funcionario (id_funcionario, nome_funcionario, cargo_funcionario, cpf_funcionario, salario_funcionario, id_setor) VALUES
    ...
    (555, 'Lorabelta', 'Operador', 12335455657, 3200, 123),
    (777, 'Viranldo', 'Zelador', 12335455657, 10000, 123),
    (561, 'lindoberto', 'Administrador', 12335455657, 7200, 123),
    (863, 'Tutaco', 'Diretor', 12335455657, 11200, 123);
