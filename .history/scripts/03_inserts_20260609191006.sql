...
INSERT INTO produto_industrial (id_produtoIndustrial, nome_produto, descricao_produto, precoFabricacao_produto, qtdEstoque_produto, categoria_produto, id_fornecedor) VALUES
    (default, 'laranja', 'podre', 2.99, 123, 'frutas', 479),
...
INSERT INTO fornecedor (id_fornecedor, cnpj_fornecedor, telefone_fornecedor, cidade_fornecedor) VALUES
    (default, 11111, 1243123451234, 'São Paulo'),
    (default, 11112, 1243123451234, 'Guarulhos'),
    (default, 11113, 1243123451234, 'Manaus'),
    (default, 11114, 1243123451234, 'São Paulo'),
    (default, 11115, 1243123451234, 'São Paulo'),
    (default, 11116, 1243123451234, 'Belo Horizonte'),
    (default, 11117, 1243123451234, 'São Paulo'),
    (default, 11118, 1243123451234, 'Rio de Janeiro'),
    (default, 11119, 1243123451234, 'São Paulo'),
    (default, 11121, 1243123451234, 'São Paulo'),
    (default, 11123, 1243123451234, 'São Paulo');
