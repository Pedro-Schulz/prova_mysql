...
INSERT INTO funcionario (id_funcionario, nome_funcionario, cargo_funcionario, cpf_funcionario, salario_funcionario, id_setor) VALUES
    (523, 'Pablo', 'Gerente', 12334455657, 1200, 123),
    ...
    (223, 'Homologo', 'Gerente', 12334455657, 1200, 123),
    (555, 'Lorabelta', 'Operador', 23567645686, 3200, 456),
    (777, 'Viranldo', 'Zelador', 123345677657, 10000, 789),
    (561, 'lindoberto', 'Administrador', 12333455657, 7200, 143),
    (863, 'Tutaco', 'Diretor', 455755657, 11200, 345);
